    ...
    def __init__(self, player_data, item_data, **kwargs):
        ...
        if player_data.chapter == 1:
            ...
            proviso2_1 = Proviso(parent=self, model='quad', texture=self.item2_1.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item2_1.name, proviso=self.item2_1.chapter_no, desc=self.item2_1.desc)

            proviso2_2 = Proviso(parent=self, model='quad', texture=self.item2_2.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item2_2.name, proviso=self.item2_2.chapter_no, desc=self.item2_2.desc)

            proviso2_3 = Proviso(parent=self, model='quad', texture=self.item2_3.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item2_3.name, proviso=self.item2_3.chapter_no, desc=self.item2_3.desc)

            proviso2_4 = Proviso(parent=self, model='quad', texture=self.item2_4.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item2_4.name, proviso=self.item2_4.chapter_no, desc=self.item2_4.desc)

            proviso2_5 = Proviso(parent=self, model='quad', texture=self.item2_5.texture, color=color.white, scale=.2,
                                 x=-.2,
            ...
            proviso4_1 = Proviso(parent=self, model='quad', texture=self.item4_1.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item4_1.name, proviso=self.item4_1.chapter_no, desc=self.item4_1.desc)

            proviso4_2 = Proviso(parent=self, model='quad', texture=self.item4_2.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item4_2.name, proviso=self.item4_2.chapter_no, desc=self.item4_2.desc)

            proviso4_3 = Proviso(parent=self, model='quad', texture=self.item4_3.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item4_3.name, proviso=self.item4_3.chapter_no, desc=self.item4_3.desc)
            ...
            proviso5_1 = Proviso(parent=self, model='quad', texture=self.item5_1.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item5_1.name, proviso=self.item5_1.chapter_no, desc=self.item5_1.desc)

            proviso5_2 = Proviso(parent=self, model='quad', texture=self.item5_2.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item5_2.name, proviso=self.item5_2.chapter_no, desc=self.item5_2.desc)

            proviso5_3 = Proviso(parent=self, model='quad', texture=self.item5_3.texture, color=color.white, scale=.2,
                                 x=-.2,
                                 y=-.2, name=self.item5_3.name, proviso=self.item5_3.chapter_no, desc=self.item5_3.desc)

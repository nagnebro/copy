...
class ReasonScene(Entity):
    ...
    def __init__(self, player):
        ...
        npc = Button(parent=self, texture='stu_pr_0',
                     scale=.4, color=color.white, x=-.6)

        npc = Button(parent=self, texture='gradu_0',
                     scale=.4, color=color.white, x=-.3)

        npc = Button(parent=self, texture='club_leader_0',
                     scale=.5, color=color.white, x=0, y=.05)

        npc = Button(parent=self, texture='prof_nam_0',
                     scale=.4, color=color.white, x=.3)

        npc = Button(parent=self, texture='ex_gf_0',
